...
const Footer = () => {
    return (
        <footer className="bg-[#111111]  opacity-90">
        <div
          className="mx-auto max-w-screen-xl  space-y-8 px-4 py-10  sm:px-6 lg:space-y-16 lg:px-8"
        >
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              ...
              Your trusted partner for exceptional services, adventures, and experiences. Explore, book, and enjoy the best of what we have to offer
              </p>
          ...
          <p className="text-xs text-white">
            &copy; 2022. TravelNest. All rights reserved.
          </p>
        </div>
      </footer>
    );
